    ...
    <section>
      ...
      <div className="container">
        <div className="st-section-heading st-style1">
          <h4 className="st-section-heading-title">Activities</h4>
          <h2 className="st-section-heading-subtitle">Activities</h2>
        </div>
        ...
        <div className="grid xl:grid-cols-3 xl:px-0 lg:grid-cols-3 lg:px-16 md:grid-cols-2 md:px-16 grid-cols-1 sm:px-16 gap-5">
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">Sharīah Consultancy</h2>
              <div className="st-iconbox-text">
                Answers the queries on evidence from Quran & authentic hadiths
          ...
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">Halaqa Session</h2>
              <div className="st-iconbox-text">
                Halaqas are arranged to confront the social issues in accordance
                with the ever changing society.
              </div>
            </div>
          </div>
          {/* <!-- .col --> */}
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">Khutbah</h2>
              <div className="st-iconbox-text">
                Delivers Jumuah Khutbah every Friday throughout the country &
                guides the Ummah in the path of the Salaf.
              </div>
            </div>
          </div>
          {/* <!-- .col --> */}
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">Erudite Scholar</h2>
              <div className="st-iconbox-text">
                Possesses great pedagogical skills & delivers lectures in the
                field of Islamic Sciences on various universities.
              </div>
            </div>
          </div>
          {/* <!-- .col --> */}
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">TV Programs</h2>
              <div className="st-iconbox-text">
                Addresses contemporary issues and crisis of the Muslim world &
                runs Islamic Reality Show based on Quran.
              </div>
            </div>
          </div>
          {/* <!-- .col --> */}
          <div className="">
            <div className="st-iconbox st-style1" data-aos="zoom-out-up" data-aos-duration="800" data-aos-delay="300">
              ...
              <h2 className="st-iconbox-title">Dawah</h2>
              <div className="st-iconbox-text">
                Runs through the countryside & preaches the right teachings of
                Islam with adequate motivation.
              </div>
            </div>
          </div>
          {/* <!-- .col --> */}
